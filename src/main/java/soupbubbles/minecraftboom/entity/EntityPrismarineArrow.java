...
public class EntityPrismarineArrow extends EntityArrow
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityPrismarineArrow.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityPrismarineArrow.PickupStatus pickupStatus;
    ...
    public EntityPrismarineArrow(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityPrismarineArrow.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
    ...
    public EntityPrismarineArrow(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntityPrismarineArrow.PickupStatus.ALLOWED;
        }
    }
...
//                f1 = 0.6F;
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityPrismarineArrow.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityPrismarineArrow.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityPrismarineArrow.PickupStatus.ALLOWED : EntityPrismarineArrow.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityPrismarineArrow.PickupStatus.ALLOWED || this.pickupStatus == EntityPrismarineArrow.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityPrismarineArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityPrismarineArrow.PickupStatus getByOrdinal(int ordinal)
        {
    ...
    public static DamageSource causeArrowDamage(EntityPrismarineArrow arrow, @Nullable Entity indirectEntityIn)
    {
