...
public class ModBlocks
{
    ...
    static
    {
        ...
        BLOCK_STAIRS_LIGHT_GRAY_TERRACOTTA = registerBlock(new BlockStairBase(Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.SILVER), Names.LIGHT_GRAY + "_" + Names.TERRACOTTA));
        ...
        BLOCK_STAIRS_LIGHT_GRAY_CONCRETE = registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.SILVER), Names.LIGHT_GRAY + "_" + Names.CONCRETE));
        ...
        BLOCK_STAIRS_WHITE_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.WHITE), Names.WHITE + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_ORANGE_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.ORANGE), Names.ORANGE + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_MAGENTA_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.MAGENTA), Names.MAGENTA + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_LIGHT_BLUE_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.LIGHT_BLUE), Names.LIGHT_BLUE + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_YELLOW_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.YELLOW), Names.YELLOW + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_LIME_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.LIME), Names.LIME + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_PINK_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.PINK), Names.PINK + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_GRAY_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.GRAY), Names.GRAY + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_LIGHT_GRAY_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.SILVER), Names.LIGHT_GRAY + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_CYAN_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.CYAN), Names.CYAN + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_PURPLE_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.PURPLE), Names.PURPLE + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_BLUE_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.BLUE), Names.BLUE + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_BROWN_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.BROWN), Names.BROWN + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_GREEN_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.GREEN), Names.GREEN + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_RED_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.RED), Names.RED + "_" + Names.TERRACOTTA_BRICKS));
        BLOCK_STAIRS_BLACK_TERRACOTTA_BRICKS = registerBlock(new BlockStairBase(BLOCK_STAINED_TERRACOTTA_BRICKS.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.BLACK), Names.BLACK + "_" + Names.TERRACOTTA_BRICKS));
