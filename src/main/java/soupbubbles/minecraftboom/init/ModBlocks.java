...
public class ModBlocks
{
    ...
    static
    {
        ...
        BLOCK_COBBLESTONE_BRICKS = registerBlock(new BlockBase(Names.BLOCK_COBBELSTONE_BRICKS).setHardness(BlockValues.COBBLESTONE_HARDENESS).setResistance(BlockValues.COBBLESTONE_RESISTANCE));
        BLOCK_MOSSY_COBBLESTONE_BRICKS = registerBlock(new BlockBase(Names.BLOCK_MOSSY_COBBELSTONE_BRICKS).setHardness(BlockValues.COBBLESTONE_HARDENESS).setResistance(BlockValues.COBBLESTONE_RESISTANCE));
        BLOCK_TERRACOTTA_BRICKS = registerBlock(new BlockBase(Names.BLOCK_TERRACOTTA_BRICKS).setHardness(BlockValues.TERRACOTTA_HARDENESS).setResistance(BlockValues.TERRACOTTA_RESISTANCE));
        BLOCK_STAINED_TERRACOTTA_BRICKS = new BlockColoredBase(Material.ROCK, Names.BLOCK_STAINED_TERRACOTTA_BRICKS).setHardness(BlockValues.TERRACOTTA_HARDENESS).setResistance(BlockValues.TERRACOTTA_RESISTANCE);
        ...
        BLOCK_MAGMA_BRICKS = registerBlock(new BlockBase(Names.BLOCK_MAGMA_BRICKS).setHardness(BlockValues.MAGMA_HARDENESS).setResistance(BlockValues.MAGMA_RESISTANCE));
        BLOCK_OBSIDIAN_BRICKS = registerBlock(new BlockBase(Names.BLOCK_OBSIDIAN_BRICKS).setHardness(BlockValues.OBSIDIAN_HARDENESS).setResistance(BlockValues.OBSIDIAN_RESISTANCE));
        ...
        BLOCK_SUGAR = registerBlock(new BlockFallingBase(Names.BLOCK_SUGAR).setHardness(BlockValues.SAND_HARDENESS).setResistance(BlockValues.SAND_RESISTANCE));
        BLOCK_SUGAR_CANE = registerBlock(new BlockPillarBase(Material.LEAVES, Names.BLOCK_SUGAR_CANE, SoundType.PLANT).setHardness(BlockValues.PLANT_BLOCK_HARDENESS).setResistance(BlockValues.PLANT_BLOCK_RESISTANCE));
        BLOCK_GUNPOWDER = registerBlock(new BlockGunpowder());
        BLOCK_BLAZE_POWDER = registerBlock(new BlockFallingBase(Names.BLOCK_BLAZE_POWDER, SoundType.SNOW).setHardness(BlockValues.SAND_HARDENESS).setResistance(BlockValues.SAND_RESISTANCE));
        BLOCK_MAGMA_CREAM = registerBlock(new BlockMagmaCream());
        BLOCK_PRISMARINE_CRYSTAL = registerBlock(new BlockPrismarineCrystal());
        BLOCK_CHARRED_BONE = registerBlock(new BlockPillarBase(Names.BLOCK_CHARRED_BONE)).setHardness(BlockValues.BONE_BLOCK_HARDENESS).setResistance(BlockValues.BONE_BLOCK_RESISTANCE);
        ...
        BLOCK_PILLAR_GRANITE = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_GRANITE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_PILLAR_DIORITE = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_DIORITE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_PILLAR_ANDESITE = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_ANDESITE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_PILLAR_PRISMARINE = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_PRISMARINE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_PILLAR_DARK_PRISMARINE = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_DARK_PRISMARINE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_PILLAR_END_STONE = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_END_STONE).setHardness(BlockValues.END_STONE_HARDENESS).setResistance(BlockValues.END_STONE_RESISTANCE));
        BLOCK_PILLAR_NETHERRACK = registerBlock(new BlockPillarBase(Names.BLOCK_PILLAR_NETHERRACK).setHardness(BlockValues.NETHER_BRICKS_HARDENESS).setResistance(BlockValues.NETHERRACK_RESISTANCE));

        BLOCK_STAIRS_STONE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.STONE), Names.STONE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_SMOOTH_GRANITE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.GRANITE_SMOOTH), Names.SMOOTH_GRANITE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_SMOOTH_DIORITE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.DIORITE_SMOOTH), Names.SMOOTH_DIORITE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_SMOOTH_ANDESITE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.ANDESITE_SMOOTH), Names.SMOOTH_ANDESITE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_MOSSY_COBBLESTONE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.MOSSY_COBBLESTONE.getDefaultState(), Names.MOSSY_COBBLESTONE).setHardness(BlockValues.COBBLESTONE_HARDENESS).setResistance(BlockValues.COBBLESTONE_RESISTANCE));
        BLOCK_STAIRS_MOSSY_STONEBRICK = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONEBRICK.getDefaultState().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.MOSSY), Names.MOSSY_STONEBRICK).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_CRACKED_STONEBRICK = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONEBRICK.getDefaultState().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.CRACKED), Names.CRACKED_STONEBRICK).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_CHISLED_STONEBRICK = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.STONEBRICK.getDefaultState().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.CHISELED), Names.CHISELED_STONEBRICK).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_TERRACOTTA = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.HARDENED_CLAY.getDefaultState(), Names.TERRACOTTA).setHardness(BlockValues.TERRACOTTA_HARDENESS).setResistance(BlockValues.TERRACOTTA_RESISTANCE));
        BLOCK_STAIRS_CHISELED_SANDSTONE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.SANDSTONE.getDefaultState().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.CHISELED), Names.CHISELED_SANDSTONE).setHardness(BlockValues.SANDSTONE_HARDENESS).setResistance(BlockValues.SANDSTONE_RESISTANCE));
        BLOCK_STAIRS_SMOOTH_SANDSTONE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.SANDSTONE.getDefaultState().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.SMOOTH), Names.SMOOTH_SANDSTONE).setHardness(BlockValues.SANDSTONE_HARDENESS).setResistance(BlockValues.SANDSTONE_RESISTANCE));
        BLOCK_STAIRS_CHISELED_RED_SANDSTONE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.RED_SANDSTONE.getDefaultState().withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.CHISELED), Names.CHISELED_RED_SANDSTONE).setHardness(BlockValues.SANDSTONE_HARDENESS).setResistance(BlockValues.SANDSTONE_RESISTANCE));
        ...
        BLOCK_STAIRS_PRISMARINE_BRICKS = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.PRISMARINE.getDefaultState().withProperty(BlockPrismarine.VARIANT, BlockPrismarine.EnumType.BRICKS), Names.PRISMARINE_BRICKS).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_DARK_PRISMARINE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.PRISMARINE.getDefaultState().withProperty(BlockPrismarine.VARIANT, BlockPrismarine.EnumType.DARK), Names.DARK_PRISMARINE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
        BLOCK_STAIRS_END_BRICKS = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.END_BRICKS.getDefaultState(), Names.END_BRICKS).setHardness(BlockValues.END_STONE_HARDENESS).setResistance(BlockValues.END_STONE_RESISTANCE));
        BLOCK_STAIRS_RED_NETHER_BRICK = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.RED_NETHER_BRICK.getDefaultState(), Names.RED_NETHER_BRICK).setHardness(BlockValues.NETHER_BRICKS_HARDENESS).setResistance(BlockValues.NETHER_BRICKS_RESISTANCE).setHardness(BlockValues.TERRACOTTA_HARDENESS).setResistance(BlockValues.TERRACOTTA_RESISTANCE));
        ...
        BLOCK_STAIRS_WHITE_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.WHITE), Names.WHITE + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_ORANGE_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.ORANGE), Names.ORANGE + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_MAGENTA_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.MAGENTA), Names.MAGENTA + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_LIGHT_BLUE_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.LIGHT_BLUE), Names.LIGHT_BLUE + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_YELLOW_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.YELLOW), Names.YELLOW + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_LIME_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.LIME), Names.LIME + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_PINK_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.PINK), Names.PINK + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_GRAY_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.GRAY), Names.GRAY + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_LIGHT_GRAY_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.SILVER), Names.SILVER + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_CYAN_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.CYAN), Names.CYAN + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_PURPLE_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.PURPLE), Names.PURPLE + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_BLUE_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.BLUE), Names.BLUE + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_BROWN_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.BROWN), Names.BROWN + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_GREEN_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.GREEN), Names.GREEN + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_RED_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.RED), Names.RED + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_BLACK_CONCRETE = (BlockStairBase) registerBlock(new BlockStairBase(Blocks.CONCRETE.getDefaultState().withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.BLACK), Names.BLACK + "_" + Names.CONCRETE).setHardness(BlockValues.CONCRETE_HARDENESS).setResistance(BlockValues.CONCRETE_RESISTANCE));
        BLOCK_STAIRS_COBBLESTONE_BRICKS = (BlockStairBase) registerBlock(new BlockStairBase(BLOCK_COBBLESTONE_BRICKS.getDefaultState(), Names.BLOCK_COBBELSTONE_BRICKS).setHardness(BlockValues.COBBLESTONE_HARDENESS).setResistance(BlockValues.COBBLESTONE_RESISTANCE));
        BLOCK_STAIRS_MOSSY_COBBLESTONE_BRICKS = (BlockStairBase) registerBlock(new BlockStairBase(BLOCK_MOSSY_COBBLESTONE_BRICKS.getDefaultState(), Names.BLOCK_MOSSY_COBBELSTONE_BRICKS).setHardness(BlockValues.COBBLESTONE_HARDENESS).setResistance(BlockValues.COBBLESTONE_RESISTANCE));
        BLOCK_STAIRS_TERRACOTTA_BRICKS = (BlockStairBase) registerBlock(new BlockStairBase(BLOCK_TERRACOTTA_BRICKS.getDefaultState(), Names.BLOCK_TERRACOTTA_BRICKS).setHardness(BlockValues.TERRACOTTA_HARDENESS).setResistance(BlockValues.TERRACOTTA_RESISTANCE));
        BLOCK_STAIRS_MAGMA_BRICKS = (BlockStairBase) registerBlock(new BlockStairBase(BLOCK_MAGMA_BRICKS.getDefaultState(), Names.BLOCK_MAGMA_BRICKS).setHardness(BlockValues.MAGMA_HARDENESS).setResistance(BlockValues.MAGMA_RESISTANCE));
        BLOCK_STAIRS_SMOOTH_PRISMARINE = (BlockStairBase) registerBlock(new BlockStairBase(BLOCK_POLISHED.getDefaultState().withProperty(BlockPolished.VARIANT, BlockPolished.EnumType.SMOOTH_PRISMARINE), Names.BLOCK_SMOOTH_PRISMARINE).setHardness(BlockValues.STONE_HARDENESS).setResistance(BlockValues.STONE_RESISTANCE));
