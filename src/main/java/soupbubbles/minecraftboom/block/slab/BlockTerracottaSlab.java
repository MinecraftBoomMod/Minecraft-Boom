...
public abstract class BlockTerracottaSlab extends BlockSlabBase
{
    protected static final PropertyEnum<BlockTerracottaSlab.EnumType> VARIANT = PropertyEnum.<BlockTerracottaSlab.EnumType>create(Assets.VARIANT_NAME_VARIANT, BlockTerracottaSlab.EnumType.class);

    public BlockTerracottaSlab(String name)
    {
        ...
        setDefaultState(iblockstate.withProperty(VARIANT, BlockTerracottaSlab.EnumType.WHITE));
    ...
    {
        return Item.getItemFromBlock(ModBlocks.BLOCK_HALF_SLAB_TERRACOTTA);
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ModBlocks.BLOCK_HALF_SLAB_TERRACOTTA, 1, state.getValue(VARIANT).getMetadata());
    }

    @Override
    public String getUnlocalizedName(int meta)
    {
        return String.format(Assets.BLOCK_PREFIX, Assets.ASSET_PREFIX, BASE_NAME + "_" + BlockTerracottaSlab.EnumType.byMetadata(meta).getUnlocalizedName());
    }
    ...
    {
        return BlockTerracottaSlab.EnumType.byMetadata(stack.getMetadata() & 7);
    }
    ...
    {
        if (this != ModBlocks.BLOCK_DOUBLE_SLAB_TERRACOTTA)
        {
            for (BlockTerracottaSlab.EnumType blockstoneslab$enumtype : BlockTerracottaSlab.EnumType.values())
            {
    ...
    {
        return ((BlockTerracottaSlab.EnumType)state.getValue(VARIANT)).getMapColor();
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final BlockTerracottaSlab.EnumType[] META_LOOKUP = new BlockTerracottaSlab.EnumType[values().length];
        ...
        public static BlockTerracottaSlab.EnumType byMetadata(int meta)
        {
        ...
        static
        {
            for (BlockTerracottaSlab.EnumType blockstoneslab$enumtype : values())
            {
